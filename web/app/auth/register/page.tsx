        ...
        <div
            ...
            <div className=" h-full w-full  bg-gradient-to-b from-black/30 to-black/50  backdrop-blur-xs flex justify-center items-center  ">
                <div className=" m-2 lg:bg-black/60 lg:m-0 lg:p-96 w-full p-2 text-center  flex flex-col gap-5 ">
                    <h1 className="  font-extrabold text-4xl">Inscription</h1>
                    <div className=" flex gap-2 rounded-full border border-red-600 w-full bg-black/80 backdrop-blur-lg">
                    <Link href={"/auth/login"}  className="rounded-full p-2 w-full text-white">Connexion</Link>
                    <Link href={"/auth/register"} className="rounded-full p-2 w-full  bg-red-600  text-white">Inscription</Link>
                    </div>
                    <div className=" flex flex-col gap-5">
                        <input type="text" placeholder="votre nom" className=" rounded-full w-full bg-black/90 p-3" />
