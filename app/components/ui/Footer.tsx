                ...
                <div className='max-w-screen-xl mx-auto px-4 md:px-8'>
                    <div className='justify-between items-center gap-12 md:flex'>
                        <div className='flex-1 max-w-lg'>
                            <Logo />
                            <div className=' mt-10  flex-1 space-y-6 justify-between sm:flex md:space-y-0'>
                                { /*-use a map loop*/}
                                <ul className='space-y-4 text-base-content'>
                                    <h4 className='text-base-content font-semibold sm:pb-2'>Congo, Brazzaville</h4>
                                    { /*-use a map loop*/}
                                    <li>
                                        <b>Tel: </b>+242 06 471 63 83
                                    </li>
                                    <li>
                                        <b>Email: </b>TheLeaderOfCommunity@gmail.com
                                    </li>
                        ...
                        <div>
                            <div className='flex-1 flex-col mt-10 md:mt-0'>
                                <div className=' md:p-5 space-y-5'>
                                    <h1 className=' text-2xl font-bold'>Rejoignez ma newsletter</h1>
                                    <p>pour ne rien ratez de mes publications aboonés vous à ma newsletter

                                    </p>
                                </div>
                                <form className='flex items-center mt-5 md:mx-5 gap-x-3 md:justify-end'>
